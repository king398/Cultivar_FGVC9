...
effnet = torch.tensor(
    np.load(
        '/home/mithil/PycharmProjects/Cultivar_FGVC9/submissions/tta/effnetv2_b3_CLAHE_augs_640_probablity.npy'))
...
sub.to_csv(
    '/home/mithil/PycharmProjects/Cultivar_FGVC9/submissions/blend/effnetv2_b3_CLAHE_augs_640_probablity_tf_effnetv2_b3_cutmix_35_own_tta_640_probablity.csv',
    index=False)

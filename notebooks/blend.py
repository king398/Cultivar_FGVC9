...
effnet_big = torch.tensor(
    np.load('/home/mithil/PycharmProjects/Cultivar_FGVC9/submissions/tf_efficientnet_b3_ns_mixup_more_epoch_tta_probablity.npy',
            allow_pickle=True),
)
ids = pd.read_csv(
...
sub.to_csv(
    '/home/mithil/PycharmProjects/Cultivar_FGVC9/submissions/blend/Effnetb3_effnetb3_blend_tta_20_30_epoch.csv',
    index=False)
